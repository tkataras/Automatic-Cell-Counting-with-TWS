...
dftc_ini <- read.csv("F:/Theo/iba_7_2020_autocount/working images/substack32_37/substack sub max project 32_37 roi blobs too results/Results class3 min size 25.csv")
### adding in the results of the hand count from roi and processing data from hand roi to count
hand_ini <- read.csv("F:/Theo/iba_7_2020_autocount/working images/substack32_37/graphs etc for poster/Results count from roi 20roi with blobs.csv")
dim(dftc_ini)
dim(hand_ini)
...
#write.csv(final_blah, "F:/Theo/iba_7_2020_autocount/working images/substack32_37/substack sub max project 32_37 roi blobs too results/final_blah_class3_min25.csv" )




#####making graphs
final_blah2 <- read.csv("F:/Theo/iba_7_2020_autocount/working images/substack32_37/graphs etc for poster/final_blah2.csv")
