...
Keep subfolders in [training_area/](training_area) and [testing_area/](testing_area) free of files other than their intended content. Failing to do so may cause the program to give incorrect results.
...
If you get an error message stating "Error when adjusting data!", it is most often solved by uninstall and reinstalling Fiji.
