...
inputdir_all <-"F:/Theo/iba_7_2020_autocount/Hina_IFNBKO_pair/working_images/8bit male microglia images (cropped) all/" #all the wt and gp images i have, 100
...
inputdir_val <- "F:/Theo/iba_7_2020_autocount/Hina_IFNBKO_pair/working_images/cropped_hand_count_male/"
