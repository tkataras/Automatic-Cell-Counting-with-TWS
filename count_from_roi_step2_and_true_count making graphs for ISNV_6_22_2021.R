...
input <- "F:/Theo/iba_7_2020_autocount/working images/substack32_37/new training/random_quarters/training_6_16_2021/class9_full_dataset_output_size20/Results.csv"
dftc_ini <- read.csv(input)
### adding in the results of the hand count from roi and processing data from hand roi to count
hand_ini <- read.csv("F:/Theo/iba_7_2020_autocount/working images/substack32_37/substack sub max project 32_37 roi blobs too results/Results_fullset_hand_6_23_21.csv")
...
#write.csv(final_blah, "F:/Theo/iba_7_2020_autocount/working images/substack32_37/new training/random_quarters/training_6_16_2021/class9_full_dataset_output/final_blah_full_dataset_class9_6_23_2021.csv" )
...
#####making graphs
class <- 9
final_blah2 <- read.csv("F:/Theo/iba_7_2020_autocount/working images/substack32_37/new training/random_quarters/training_6_16_2021/class9_full_dataset_output/final_blah_full_dataset_class9_6_23_2021.csv")
geno <- final_blah2$geno
sex <- final_blah2$sex
final_blah
...
final_blah3 <- cbind(final_blah,geno, sex)
...
t.test(final_blah3$prec2 ~ final_blah3$geno)
t.test(final_blah3$reca2 ~ final_blah3$geno)
...
your_boat <- NA
row_row <- cbind(class,prec,reca,F1,F1_g_tt_p, F1_s_tt_p,mean_F1_m, mean_F1_f,mean_F1_gp,mean_F1_wt)
your_boat <- rbind(your_boat, row_row)


write.csv(your_boat, "F:/Theo/iba_7_2020_autocount/working images/substack32_37/new training/random_quarters/training_6_16_2021/only_gp_train_on_val.csv")
