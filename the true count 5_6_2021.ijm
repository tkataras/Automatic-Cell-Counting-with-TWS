...
input = "F:/Theo/iba_7_2020_autocount/working images/substack32_37/code_practice/post_weka/"
dir2 = "F:/Theo/iba_7_2020_autocount/working images/substack32_37/code_practice/roi/"
output = "F:/Theo/iba_7_2020_autocount/working images/substack32_37/code_practice/counted/"
...
for (q = 0; q < list.length; q++)
        action(input, output, list[q], dir2, list2[q], testing);


//describes the actions for each image
function action(input, output, filename, input2, filename2, testing) {
