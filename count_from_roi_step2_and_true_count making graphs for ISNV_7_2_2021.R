...
input <- "F:/Theo/iba_7_2020_autocount/working images/substack32_37/new training/random_quarters/new_male_only_6_24/classifiers/class15_mask/Results.csv"
dftc_ini <- read.csv(input)
### adding in the results of the hand count from roi and processing data from hand roi to count
hand_ini <- read.csv("F:/Theo/iba_7_2020_autocount/working images/substack32_37/new training/random_quarters/new_male_only_6_24/validation_roi/Results.csv")
...
row_row <- cbind(i,prec,reca,F1,F1_g_tt_p, mean_F1_gp,mean_F1_wt)#F1_s_tt_p,mean_F1_m, mean_F1_f
