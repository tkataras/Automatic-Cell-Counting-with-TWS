...
input <- "F:/Theo/iba_7_2020_autocount/Hina_IFNBKO_pair/automatic_segmentation/run_1/output/comparison_to_my_hand_count/Results.csv"
...
###you have to specify how many i each time!!!!
your_boat <- NA
for (i in 1:4){
# i = 4
...
# 
 final_blah2 <- read.csv("F:/Theo/iba_7_2020_autocount/Hina_IFNBKO_pair/automatic_segmentation/run_1/output/comparison_to_my_hand_count/class1final_geno.csv")
