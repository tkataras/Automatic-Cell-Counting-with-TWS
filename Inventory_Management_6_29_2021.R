...
newst_use <- assign(newst_use,match_id2, how = "t")
...
write.csv(big_df,"F:/Theo/iba_7_2020_autocount/working images/substack32_37/new training/random_quarters/new_male_only_6_24/big_df_6_29_2021v2.csv")

new_big_df <- read.csv("F:/Theo/iba_7_2020_autocount/working images/substack32_37/new training/random_quarters/new_male_only_6_24/big_df_6_29_2021v2.csv")
newest_big_df <- cbind(new_big_df,newst_use)

newest_big_df_m <- newest_big_df[newest_big_df$sex == "m",]
dim(newest_big_df_m)

unused <- newest_big_df_m[is.na(newest_big_df_m$newst_use),]
dim(unused)
