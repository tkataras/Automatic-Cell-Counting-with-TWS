...
hand_ini <- read.csv("F:/Theo/iba_7_2020_autocount/working images/substack32_37/substack sub max project 32_37 roi blobs too results/Results hand full dataset 6_14_2021.csv")
...
###need to add the genotype and sex info, i do so in excell
#####making graphs
final_blah2 <- read.csv("F:/Theo/iba_7_2020_autocount/working images/substack32_37/substack sub max project 32_37 roi blobs too results/final_blah_class3_min25.csv")
...
names(final_blah2)
names(final_blah2)[11] <- "hand_count"  ###this will change based on the number of columns in the data*(currently assumes you added geno and sex)
