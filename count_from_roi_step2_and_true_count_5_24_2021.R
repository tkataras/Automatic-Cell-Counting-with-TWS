...
####making the mead and sd plot

#create dataframe
Gene<-c("Wild Type","HIVgp120","Wild Type","HIVgp120")
...
mean3<-me_h_gp
mean4<-me_a_gp
Gene1SpeciesA.stdev<-sd_h_wt
Gene2SpeciesA.stdev<-sd_a_wt
Gene1SpeciesB.stdev<-sd_h_gp
Gene2SpeciesB.stdev<-sd_a_gp
...
#add legend
# legend("topright", 
#        legend = c("Hand Count","Auto Count"), 
#        fill = c("blue","red"))
