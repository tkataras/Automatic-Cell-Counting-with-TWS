...
getwd()
setwd("F:/Theo/iba_7_2020_autocount/Hina_IFNBKO_pair/working_images/new_val_train_etc/class_output/")

#getting the number of needed folder from # classifier.model files in folder with ONLY classifier.model files
n= length(dir("F:/Theo/iba_7_2020_autocount/Hina_IFNBKO_pair/working_images/new_val_train_etc/class/")) 
nm = "masks_class"
for (i in 1:n){
