...
getwd()
setwd("F:/Theo/iba_7_2020_autocount/Hina_IFNBKO_pair/working_images/new_val_train_etc/class_8bit_thresh_projected/")
...
for (i in 1: length(u_img)){
  ...
  if (length(this_group) == 2){
    ...
    file_out_loc <- paste("F:/Theo/iba_7_2020_autocount/Hina_IFNBKO_pair/working_images/new_val_train_etc/test/test_class_project/proj_thresh_masks_class",j,"/",this_group[1], sep = "")
