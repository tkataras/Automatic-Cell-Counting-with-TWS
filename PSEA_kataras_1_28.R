...
neuron_genes=c("Nefm")# could add more genes here "neurofiliment medium gene
...
astrocyte_genes=c("Aldh1l1")# tried Glt1, but it didnt work, no matches, 
...
oligo_genes=c("Olig1", "Olig2", "Olig3")
