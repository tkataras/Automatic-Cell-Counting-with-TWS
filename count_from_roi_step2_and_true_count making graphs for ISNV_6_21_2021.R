...
dftc_ini <- read.csv("F:/Theo/iba_7_2020_autocount/working images/substack32_37/substack sub max project 32_37 roi blobs too results/Resultsclass5fulldataset_6_16_2021.csv")
### adding in the results of the hand count from roi and processing data from hand roi to count
hand_ini <- read.csv("F:/Theo/iba_7_2020_autocount/working images/substack32_37/substack sub max project 32_37 roi blobs too results/Results_fullset_hand_6_21_21.csv")
...
# lucky
# t.test(lucky2$count ~ lucky$geno)
# t.test(lucky2$count ~ lucky$sex)
...
write.csv(final_blah, "F:/Theo/iba_7_2020_autocount/working images/substack32_37/substack sub max project 32_37 roi blobs too results/final_blah_full_dataset_class5_6_16_2021.csv" )



###need to add the genotype and sex info, also the final auto count from tp+fp, i do so in excell
#####making graphs
final_blah2 <- read.csv("F:/Theo/iba_7_2020_autocount/working images/substack32_37/substack sub max project 32_37 roi blobs too results/final_blah_full_dataset_class5_6_16_2021.csv")

# #just male
# final_blah2_m <- final_blah2[final_blah2$sex == "m",]
# dim(final_blah2_m)
...
prec2 <- final_blah2$tp/(final_blah2$tp + final_blah2$fp)

reca2 <-final_blah2$tp/(final_blah2$tp + final_blah2$fn)
F1_2 <- 2*(prec2*reca2/(prec2 + reca2))

final_blah2 <- cbind(final_blah2, prec2)
final_blah2 <- cbind(final_blah2, reca2)
final_blah2 <- cbind(final_blah2, F1_2)


t.test(final_blah2$prec2 ~ final_blah2$geno)
t.test(final_blah2$reca2 ~ final_blah2$geno)
t.test(final_blah2$F1_2 ~ final_blah2$geno)

t.test(final_blah2$F1_2 ~ final_blah2$sex)


wt_prec_m <- mean(final_blah2$prec2[final_blah2$geno == "wt"])
wt_prec_sd <-sd(final_blah2$prec2[final_blah2$geno == "wt"])

wt_reca_m <- mean(final_blah2$reca2[final_blah2$geno == "wt"])
wt_reca_sd <-sd(final_blah2$reca2[final_blah2$geno == "wt"])





gp_prec_m <- mean(final_blah2$prec2[final_blah2$geno == "gp"])
gp_prec_sd <- sd(final_blah2$prec2[final_blah2$geno == "gp"])

gp_reca_m <- mean(final_blah2$reca2[final_blah2$geno == "gp"])
gp_reca_sd <-sd(final_blah2$reca2[final_blah2$geno == "gp"])
...
final_blah2 <- cbind(final_blah2,final$count)
names(final_blah2)
names(final_blah2)[12] <- "hand_count"  ###this will change based on the number of columns in the data*(currently assumes you added geno and sex)
me_h_wt <- mean(final_blah2$hand_count[final_blah2$geno == "wt"])
sd_h_wt <- sd(final_blah2$hand_count[final_blah2$geno == "wt"])

me_h_gp <- mean(final_blah2$hand_count[final_blah2$geno == "gp"])
sd_h_gp <- sd(final_blah2$hand_count[final_blah2$geno == "gp"])

me_a_wt <- mean(final_blah2$auto_count[final_blah2$geno == "wt"])
sd_a_wt <- sd(final_blah2$auto_count[final_blah2$geno == "wt"])

me_a_gp <- mean(final_blah2$auto_count[final_blah2$geno == "gp"])
sd_a_gp <- sd(final_blah2$auto_count[final_blah2$geno == "gp"])

t.test(final_blah2$auto_count ~ final_blah2$geno)
t.test(final_blah2$hand_count ~ final_blah2$geno)

t.test(final_blah2$hand_count[final_blah2$geno == "wt"],final_blah2$auto_count[final_blah2$geno == "wt"])
t.test(final_blah2$hand_count[final_blah2$geno == "gp"],final_blah2$auto_count[final_blah2$geno == "gp"])


var.test(final_blah2$hand_count[final_blah2$geno == "gp"], final_blah2$auto_count[final_blah2$geno == "gp"])
...
boxplot(final_blah2$auto_count ~ final_blah2$geno)
stripchart(as.numeric(final_blah2$auto_count) ~ final_blah2$geno, vertical = TRUE,
           method = "jitter", add = TRUE, pch = 20, col = 'blue')

boxplot(final_blah2$auto_count ~ final_blah2$sex)
stripchart(as.numeric(final_blah2$auto_count) ~ final_blah2$sex, vertical = TRUE,
           method = "jitter", add = TRUE, pch = 20, col = 'blue')

t.test(final_blah2$prec2 ~ final_blah2$sex)

boxplot(final_blah2$prec2 ~ final_blah2$sex)
stripchart(as.numeric(final_blah2$prec2) ~ final_blah2$sex, vertical = TRUE,
           method = "jitter", add = TRUE, pch = 20, col = 'blue')

boxplot(final_blah2$F1_2 ~ final_blah2$sex)
stripchart(as.numeric(final_blah2$F1_2) ~ final_blah2$sex, vertical = TRUE,
           method = "jitter", add = TRUE, pch = 20, col = 'blue')
...
### making corr plots
X11()
plot(final_blah2$hand_count[final_blah2$geno == "wt"],final_blah2$auto_count[final_blah2$geno == "wt"])
X11()
plot(final_blah2$hand_count[final_blah2$geno == "gp"],final_blah2$auto_count[final_blah2$geno == "gp"])


WT = lm(final_blah2$hand_count[final_blah2$geno == "wt"] ~final_blah2$auto_count[final_blah2$geno == "wt"])
summary(WT)
X11()
plot((final_blah2$hand_count[final_blah2$geno == "wt"] ~final_blah2$auto_count[final_blah2$geno == "wt"]),  pch = 20, col = "gray" , cex = 2,ylim = c(50,250), xlim = c(50,250))
abline(lm(WT), lwd=2)

GP = lm(final_blah2$hand_count[final_blah2$geno == "gp"] ~final_blah2$auto_count[final_blah2$geno == "gp"])
summary(GP)
X11()
plot((final_blah2$hand_count[final_blah2$geno == "gp"]~final_blah2$auto_count[final_blah2$geno == "gp"]),  pch = 20, col = "gray" , cex = 2,ylim = c(50,250), xlim = c(50,250))
abline(lm(GP), lwd=2)
