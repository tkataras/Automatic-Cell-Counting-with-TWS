...
# 
# #this might be the subset of the data used for analysis
...
model2_oligo <- lm(exprl[goi,] ~ oligo_reference +  oligo_difference)
  ...
  ##looks like this is taking all parts of a multiple linear mdoel except the intercept, which wouldnt be relevant
# model_subset goes up to 9 for 1 + 4 refernce + difference coefficients
...
##oh my god i might have used an apply function correctly
...
table_full[table_full$symbols == "Gbp3",]

(table_full$symbols == "Gbp3")
#astro order
