...
fname <- "F:/Theo/iba_7_2020_autocount/working images/substack32_37/new training/random_quarters/new_male_only_6_24/roi_v2_7_9_2021_results/Results_7_11_2021.csv"
...
setwd("F:/Theo/iba_7_2020_autocount/working images/substack32_37/new training/random_quarters/new_male_only_6_24/roi_v2_7_9_2021_results/") 
...
df <- read.csv("F:/Theo/iba_7_2020_autocount/working images/substack32_37/new training/random_quarters/new_male_only_6_24/roi_v2_7_9_2021_results/Results_7_11_2021_summed_geno.csv")
...
input <- "F:/Theo/iba_7_2020_autocount/working images/substack32_37/new training/random_quarters/new_male_only_6_24/classifiers_gp/v2/class4_counted/Results.csv"
dftc_ini <- read.csv(input)
### adding in the results of the hand count from roi and processing data from hand roi to count
hand_ini <- read.csv("F:/Theo/iba_7_2020_autocount/working images/substack32_37/new training/random_quarters/new_male_only_6_24/validation results m gp only.csv")
...
holding_wt_blah <- final_blah[9:16,]
holding_wt_blah$geno <- "wt"
dim(final_blah)
gp_in <-read.csv("F:/Theo/iba_7_2020_autocount/working images/substack32_37/new training/random_quarters/new_male_only_6_24/classifiers_gp/class3_full_dataset_output/class3final.csv")
dim(gp_in)
holding_gp_blah <- gp_in[1:8,2:6]

combo_blah <- rbind(holding_gp_blah,holding_wt_blah)
final_blah3 <- combo_blah
...
test <- lm(final_blah3$hand_count ~ final_blah3$auto_count)
summary(test)
