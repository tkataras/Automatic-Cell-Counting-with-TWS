...
neuro_plot1 = ggplot(data = model_big, aes(x = neuron_reference, y = .resid + as.matrix(model_big$model[, c("neuron_reference", g)]) %*% model_big$coef[c("neuron_reference", g)])) + 
  geom_point() + 
...
micro_plot1 = ggplot(model_big, aes(x = microglia_reference, y = .resid + as.matrix(model_big$model[, c("microglia_reference", g)]) %*% model_big$coef[c("microglia_reference", g)])) + 
  geom_point() +  
...
astro_plot1 = ggplot(model_big, aes(x = astrocyte_reference, y = .resid + as.matrix(model_big$model[, c("astrocyte_reference", g)]) %*% model_big$coef[c("astrocyte_reference", g)])) + 
  geom_point() + 
...
grid.arrange(neuro_plot1,micro_plot1,astro_plot1,oligo_plot1, age_plot1,sex_plot1,  nrow = 2) #endoth_plot1,strain_plot1,
