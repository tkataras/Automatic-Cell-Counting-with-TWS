...
getwd()
CLASS_ORIGIN <- "F:/Theo/iba_7_2020_autocount/Hina_IFNBKO_pair/working_images/new_val_train_etc/new_new_train/troubleshooting_0_count_fail/class_8bit/"
setwd(CLASS_ORIGIN)
...
prenums3 <- lapply(strsplit(prenums2, split = ""), function(x) x[1])
