...
setwd("E:/For Jeff/Iba1 cropped/")
setwd("F:/Theo/iba_7_2020_autocount/working images/substack32_37/holdig/")
...
num_draws <- 13#use input desired number of images to be randomly selected with nonrepeating integers
...
num_subsection <- 1
dim_subsection <- 576 #this will currently give 4 subsections
