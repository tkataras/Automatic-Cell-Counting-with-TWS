...
dftc_ini <- read.csv("F:/Theo/iba_7_2020_autocount/working images/substack32_37/graphs etc for poster/Results from full datase hand count with blobs class 3 fixel pixel size no blank.csv")
...
write.csv(final_blah, "F:/Theo/iba_7_2020_autocount/working images/substack32_37/graphs etc for poster/final_blah.csv" )
...
#####making graphs
final_blah2 <- read.csv("F:/Theo/iba_7_2020_autocount/working images/substack32_37/graphs etc for poster/final_blah_for poster.csv")

##final itself is the hand counts
final_blah2 <- cbind(final_blah2,final$count)

names(final_blah2)[9] <- "hand_count"
...
df1 <- cbind(c("wt","wt", "gp", "gp"), c("hand", "auto", "hand", "auto"), as.numeric(c(135,143.5455,161.5556,151.3333)), as.numeric(c(25.12369,25.62172,26.01976,60.77829)) )
df1 <- data.frame(df1)
