...
setwd("F:/Theo/iba_7_2020_autocount/working images/substack32_37/new training/random_quarters/new_male_only_6_24/training/")
...
num_subsection <- 1
dim_subsection <- 640 #this will currently give 4 subsections
