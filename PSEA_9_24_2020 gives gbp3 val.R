###this code exactly as it is gives gbp3 as top
...
probe_id <- "ILMN_1220911"
goi <- exprl[probe_id,]
title =goi_name=mapIds(illuminaMousev2.db, keys=probe_id, column='SYMBOL', keytype='PROBEID',multiVals="list")
...
for(i in 1:length(mylevels)){
  ...
  thisvalues <- goi[information$`genotype:ch1` ==thislevel]
