...
plot(coefficients[,1] / average_expression, adjusted_R2,
     pch=".", ylab="Adjusted R squared", xlab="Intercept/average expression") 
...
plot(coefficients[filter,2] /
       average_expression[filter], -log10(pvalues[filter,2]), ylab="-log10 p value", xlab = "Neuron expression/average expression")#, abline(h = 1.3))

#astro
#X11()
plot(coefficients[filter,3] /
       average_expression[filter], -log10(pvalues[filter,3]), ylab="-log10 p value", xlab = "Astrocyte expression/average expression")#, abline(h = 1.3))

#oligo
#X11()
plot(coefficients[filter,4] /
       average_expression[filter], -log10(pvalues[filter,4]), ylab="-log10 p value", xlab = "Oligodendrocyte expression/average expression")#, abline(h = 1.3))
#micro
#X11()
plot(coefficients[filter,5] /
       average_expression[filter], -log10(pvalues[filter,5]), ylab="-log10 p value", xlab = "Microglia expression/average expression")#, abline(h = 1.3))
...
X11()
#png(file="mygraphic_11_6.png",width=1536,height=820)
png(file="mygraphic_11_8_1.png",width=600,height=800)
...
boxplot(exprl["ILMN_1232278",]~information$`genotype:ch1`,
        ...
        ylab="expression",
        col="orange",
        border="brown", cex = 1.5
)

crplot(model2_neuro, "neuron_reference", g="neuron_difference",newplot = F, ylab = NA, main = "ILMN_1232278", yaxt='n', xlab="neuron ref.")
...
crplot(model2_neuro, "neuron_reference", g="neuron_difference",newplot = F, ylab = NA, main = "ILMN_1248892", yaxt='n', xlab="neuron ref.")
...
crplot(model2_neuro, "neuron_reference", g="neuron_difference",newplot = F, ylab = NA, main = "ILMN_1216813", yaxt='n', xlab="neuron ref.")
...
crplot(model2_micro, "microglia_reference", g="microglia_difference",newplot = F, ylab = NA, main = "ILMN_1244513", yaxt='n', xlab="microglia ref.")
...
crplot(model2_micro, "microglia_reference", g="microglia_difference",newplot = F, ylab = NA, main = "ILMN_2615380", yaxt='n', xlab = "microglia ref.")
...
crplot(model2_micro, "microglia_reference", g="microglia_difference",newplot = F, ylab = NA, main = "ILMN_2862026", yaxt='n', xlab="microglia ref")
...
crplot(model2_micro, "microglia_reference", g="microglia_difference",newplot = F, ylab = NA, main = "ILMN_1257623", yaxt='n', xlab="microglia ref.")
...
crplot(model2_micro, "microglia_reference", g="microglia_difference",newplot = F, ylab = NA, main = "ILMN_2610706", yaxt='n', xlab="microglia ref.")
...
crplot(model2_micro, "microglia_reference", g="microglia_difference",newplot = F, ylab = NA, main = "ILMN_2910934", yaxt='n', xlab="microglia ref.")
...
crplot(model2_oligo, "oligo_reference", g="oligo_difference",newplot = F, ylab = NA, main = "ILMN_2547305", yaxt='n', xlab="oligodendrocyte ref.")
