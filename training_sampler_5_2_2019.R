...
setwd("F:/Theo/iba_7_2020_autocount/working images/output/")
...
num_draws <- 30#use input desired number of images to be randomly selected with nonrepeating integers
